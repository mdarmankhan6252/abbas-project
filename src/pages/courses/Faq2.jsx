   ...
   const accordingData = [
      {
         ...
         reasons : [
            "যারা মোবাইল দিয়েই প্রফেশনাল কন্টেন্ট বানাতে চান।",
            "নতুন ফেইসবুক এবং ইউটিউব কন্টেন্ট ক্রিয়েটররা যারা দ্রুত সফল হতে চান।",
            "ফ্রিল্যান্সাররা যারা ফেইসবুক এবং ইউটিউব থেকে ইনকাম করতে চান।",
            "চাকরিজীবী, স্টুডেন্ট বা গৃহিণী যারা ফেইসবুক এবং ইউটিউবকে প্যাসিভ ইনকামের সোর্স হিসেবে গড়ে তুলতে চান।"
         ]
      },
      {
         ...
         {accordingData?.map((according, index) => (
            ...
            >
               ...
               >
                  ...
                  {according.reasons.length > 0 && (
                     <div className={`mt-2 ml-3 grid grid-cols-1 gap-1 `}>
                        {according.reasons.map((reason, index) => (
                           <li key={index} className={`text-[#424242] text-[0.9rem] overflow-hidden ${isAccordingOpen && 'hidden'}`}>
                              {reason}
                           </li>
                        ))}
                     </div>
